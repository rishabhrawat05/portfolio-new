...
const Activites=()=>{
    ...
    return(
        <div className="activites">
             ...
             <p style={{display:'flex', alignItems:'center', justifyContent:'space-between', gap:'2%', width:'11vh'}}><RiGithubFill color="white"/><a href="https://github.com/rishabhrawat05/NothingPhone-1" style={{fontSize:'2vh'}} target="_blank">Github</a></p>
             </div>
             ...
             <p style={{display:'flex', alignItems:'center', justifyContent:'space-between', gap:'2%', width:'11vh'}}><RiGithubFill color="white"/><a href="https://github.com/rishabhrawat05/Brooklyn-Stoop-Sale" style={{fontSize:'2vh'}} target="_blank">Github</a></p>
             ...
             <div className="about">
                ...
                <p style={{display:'flex', alignItems:'center', justifyContent:'space-between', gap:'5%', width:'11vh'}}><RiMapPinUserFill color="white"/><a href="https://www.holopin.io/@rishabhrawat05#" style={{fontSize:'2vh'}} target="_blank">Holopin</a></p>
             </div>
             ...
             <div className="about">
                ...
                <p style={{display:'flex', alignItems:'center', justifyContent:'space-between', gap:'2%', width:'11vh'}}><RiGithubFill color="white"/><a href="https://github.com/rishabhrawat05#-ggsoc24-badges" style={{fontSize:'2vh'}} target="_blank">Github</a></p>
             </div>
             ...
             <div className="about">
                ...
                <p style={{display:'flex', alignItems:'center', justifyContent:'space-between', gap:'7%', width:'11vh'}}><SiDevpost color="white" size={30} /><a href="https://devpost.com/rishabhrawat05" style={{fontSize:'2vh'}} target="_blank">Devpost</a></p>
             </div>
